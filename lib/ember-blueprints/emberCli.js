...
var spawn = require('child_process').spawn,
    log = require('./log'),
    chalk = require('chalk'),
    output = require('./emberCli/output').output;

exports.emberCli = EmberCli;

function EmberCli() {
  this.logData = '';
  //this.ember = __dirname + '/../../node_modules/ember-cli/bin/ember';
  this.ember = 'ember';
...
EmberCli.prototype.installPackages = function(packages, options) {
  ...
  return new Promise(function(resolve, reject){
    ...
    return Promise.all(packages.map(function(packageName){
      return this.runCommand(this.ember, ['install', packageName], options);
    }.bind(this)))
    .then(function() {
